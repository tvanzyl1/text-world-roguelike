...
//		String[][] str = GenerationService.emptyMap();
	...
	//max size of the map
	private static int xmax = 75; //80 columns
	private static int ymax = 20; //25 rows
	...
	//used to print the map on the screen
	public static void genBuilding(List<Object> valueList){
		...
		for (int y = 0; y < ysize; y++){
			for (int x = 0; x < xsize; x++){
				...
				case tileUnused:
					break;
				case tileDirtWall:
					obj = MapService.BuildingWall(x, y);
					break;
				case tileDirtFloor:
					obj = MapService.BuildingFloor(x, y);
					break;
				case tileStoneWall:
					break;
				case tileCorridor:
	...
	public static boolean createBuilding(int inx, int iny, int inobj){
